        ...
        Material =
            [
                new THREE.MeshBasicMaterial({
                    map: new THREE.TextureLoader().load("hw_hourglass/hourglass_ft.jpg"),
                    side: THREE.BackSide
                }),
                new THREE.MeshBasicMaterial({
                    map: new THREE.TextureLoader().load("hw_hourglass/hourglass_bk.jpg"),
                    side: THREE.BackSide
                }),
                new THREE.MeshBasicMaterial({
                    map: new THREE.TextureLoader().load("hw_hourglass/hourglass_up.jpg"),
                    side: THREE.BackSide
                }),
                new THREE.MeshBasicMaterial({
                    map: new THREE.TextureLoader().load("hw_hourglass/hourglass_dn.jpg"),
                    side: THREE.BackSide
                }),
                new THREE.MeshBasicMaterial({
                    map: new THREE.TextureLoader().load("hw_hourglass/hourglass_rt.jpg"),
                    side: THREE.BackSide
                }),
                new THREE.MeshBasicMaterial({
                    map: new THREE.TextureLoader().load("hw_hourglass/hourglass_lf.jpg"),
                    side: THREE.BackSide
                })
